...
|---|---|---|
| **M0 — Foundation** (week 1) | App runs, contract frozen, CI green | US-080, US-001, US-002, US-003, US-004, US-005, US-006, US-010, US-011, US-012, US-014, US-015, US-120 |
| **M1 — PSY0 MVP** | Learn + Practice + Exam sim + Progress on the 7 MVP activities (N-back, rules S-R, parity, dominos, arithmetic grids, culture aéro, English reading) | US-013, US-020…024, US-026…029, US-031, US-040, US-041, US-050…052, US-060…062, US-070, US-071, US-075, US-081…083, US-090 |
| **M2 — PSY0 complete** | All 14 activities, flashcards, retry, weak areas, i18n, release builds | US-025, US-030, US-032…036, US-042…044, US-054, US-064, US-072, US-084…087, US-091, US-121, US-122 |
| **M3 — Polish** | Adaptive difficulty, realism, streaks, backup, a11y | US-053, US-063, US-073, US-074, US-092, US-093, US-123 |
...
|---|---|---|---|
| `core` | Flutter dev (architecture) | — | US-001, 002, 004, 005, 006, 010, 011, 012, 013, 015, 120–122 |
| `design` | UI-minded dev | US-001 | US-003, 123 |
| `engines` | Flutter/Dart dev, likes algorithms | US-015 → US-020 | US-020–036 (one activity per person once US-020 is merged) |
...
- Engines are **independent of each other**: the 14 activity stories (US-023–036) can each be
  taken by a different person the day US-020 merges. US-027/028 are thin (bank-driven).
- Practice UI (US-051) only needs *one* engine to be testable — start with US-028 (culture MCQ,
  simplest) or US-023 (arithmetic grids).
- **Reality check (US-080, `docs/content/psy0-spec.md`)**: PSY0 is ~14 Pilotest-like cognitive
  games + culture MCQ + English, on a desktop app with keyboard. Hence US-006 (desktop/web) and
  US-015 (contract v2) in M0.
...
flowchart LR
  ...
  US010 --> US015[US-015 contract v2] --> US020[US-020 engine runtime ★]
  US080 --> US015
  ...
  US020 --> US023[US-023 arithmetic grids] & US024[US-024 dominos] & US026[US-026 n-back] & US029[US-029 rules S-R] & US031[US-031 parity]
  US021 --> US027[US-027 english] & US028[US-028 culture aéro]
  ...
  US075 --> US062
  US010 & US014 --> US082[US-082 english bank] & US083[US-083 culture bank]
  US010 --> US081
```
...
2. US-015 → US-020 → US-021 → US-028 → US-050 → US-051 → US-052 (first end-to-end drill)
3. US-075 → US-070 → US-071 (progress visible)
4. US-023 → US-026 → US-029 → US-031 → US-024 → US-027 (+ content US-082/083 in the evenings)
