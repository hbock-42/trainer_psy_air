...
| [psy1-spec.md](psy1-spec.md) | Research on the in-person PSY1 day at ENAC: modality, hardware (joysticks/keyboard), the ~13 psychotechnical/psychomotor activity families with formats/timings, which ones a keyboard/mouse/gamepad app can rehearse faithfully, proposed `psy1_full` / `psy1_short` blueprints, mapping to the EPIC-03/EPIC-10 engine runtime (including the new input abstraction the joystick psychomotor test needs), recommended kanban edits for US-101/102/103, open questions, sources, legal note. Every claim is tagged **[confirmed]** / **[reported]** / **[assumed]**. | US-100 |
