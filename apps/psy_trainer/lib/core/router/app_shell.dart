...
class AppShell extends StatelessWidget {
  ...
  static List<AppTabItem> tabsOf(BuildContext context) => [
    AppTabItem(label: context.l10n.tabLearn, glyph: AppIconGlyph.book),
    AppTabItem(label: context.l10n.tabTrain, glyph: AppIconGlyph.target),
    AppTabItem(label: context.l10n.tabExam, glyph: AppIconGlyph.clock),
    AppTabItem(label: context.l10n.tabProgress, glyph: AppIconGlyph.chart),
    AppTabItem(label: context.l10n.tabSettings, glyph: AppIconGlyph.settings),
  ];
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final tabBar = AppTabBar(
            ...
            semanticsLabel: context.l10n.tabBarLabel,
          );
